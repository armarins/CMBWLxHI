...
if params_APS['field_2'].lower() == 'hi':
    ...
    #print(params_APS['field_2_params']['include_mb'])
    #print(params_APS['field_2_params']['include_rsd'])    
    #W_f2_j = cxft.kernel_galaxy_clustering_i_dict(camb_params       = pars, 
    #                                              camb_results      = results, 
    #                                              growth_rate_f     = None, 
    #                                              Np                = 5000, 
