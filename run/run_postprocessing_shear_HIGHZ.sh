#!/bin/bash
NAME_RUN="LSST_HIGHZ_SHEAR_256_postprocessing"
...
for i in $(seq $bin_min $bin_max); do
    for j in $(seq $ns_min $ns_max); do
        ...
        FILEPATH_FIELD1="/data/AMARINS/LSSxHI-DATA/theoretical/GWLxHI/LSSTY10_bin${i}_${FIELD1}_cl_nch70_350_1050.txt"
        FILEPATH_FIELD2="/data/AMARINS/LSSxHI-DATA/theoretical/GWLxHI/LSSTY10_bin${i}_${FIELD2}_cl_nch70_350_1050.txt"  
        FILEPATH_CROSS="/data/AMARINS/LSSxHI-DATA/theoretical/GWLxHI/LSSTY10_bin${i}_${FIELD1}x${FIELD2}_cl_nch70_350_1050.txt"
        DIRPATH_SIMS="/data/AMARINS/LSSxHI-DATA/simulations/GWLxHI/LSSTY10_nch70_350_1050/bin${i}"        
        DIRPATH_ESTIMATED="/data/AMARINS/LSSxHI-DATA/FGremoval/GWLxHI/LSSTY10_nch70_350_1050/bin${i}/fullsky"
        DIRPATH_OUT="/data/AMARINS/LSSxHI-DATA/postprocessed/GWLxHI/LSSTY10_nch70_350_1050/bin${i}/fullsky"
