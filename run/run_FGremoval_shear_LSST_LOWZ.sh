#!/bin/bash
NAME_RUN="LSSTY10_nch30_980_1260_256_SHEAR_fgremoval"
...
for i in $(seq $bin_min $bin_max); do
    for j in $(seq $ns_min $ns_max); do
        ...
        FILEPATH_FIELD1="/data/AMARINS/LSSxHI-DATA/theoretical/GWLxHI/LSSTY10_bin${i}_${FIELD1}_cl_nch30_980_1260.txt"
        FILEPATH_FIELD2="/data/AMARINS/LSSxHI-DATA/theoretical/GWLxHI/LSSTY10_bin${i}_${FIELD2}_cl_nch30_980_1260.txt"  
        FILEPATH_CROSS="/data/AMARINS/LSSxHI-DATA/theoretical/GWLxHI/LSSTY10_bin${i}_${FIELD1}x${FIELD2}_cl_nch30_980_1260.txt"
        DIRPATH_SIMS="/data/AMARINS/LSSxHI-DATA/simulations/GWLxHI/LSSTY10_nch30_980_1260/bin${i}"
