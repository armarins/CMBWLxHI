#!/bin/bash
NAME_RUN="LSSTY10_nch70_350_1050_SHEAR"
...
do
    ...
    FILEPATH_FIELD1="/data/AMARINS/LSSxHI-DATA/theoretical/GWLxHI/LSSTY10_bin${i}_HI_cl_nch70_350_1050.txt"
    FILEPATH_FIELD2="/data/AMARINS/LSSxHI-DATA/theoretical/GWLxHI/LSSTY10_bin${i}_SHEAR_cl_nch70_350_1050.txt"  
    FILEPATH_CROSS="/data/AMARINS/LSSxHI-DATA/theoretical/GWLxHI/LSSTY10_bin${i}_HIxSHEAR_cl_nch70_350_1050.txt"
