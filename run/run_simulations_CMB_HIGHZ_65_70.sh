#!/bin/bash
NAME_RUN="CMB_HIGHZ_256_nch70_65_70"
...
#TERMINAL INFO
VERBOSE=1
PROJECT='CMB_HIGHZ_nch70_350_1050_65_70'
FILEPATH_FIELD1='/data/AMARINS/LSSxHI-DATA/theoretical/CMBWLxHI/CMBWL_HI_cl_nch70_350_1050.txt'
FILEPATH_FIELD2='/data/AMARINS/LSSxHI-DATA/theoretical/CMBWLxHI/CMBWL_CMBWL_cl_nch70_350_1050.txt'
FILEPATH_CROSS='/data/AMARINS/LSSxHI-DATA/theoretical/CMBWLxHI/CMBWL_HIxCMBWL_cl_nch70_350_1050.txt'
#
